<template>
  <div class="project-container other-projects-container">
    ...
    <section class="other-projects">
      <OtherProject
        ...
        :visitLink="'https://repofinder.netlify.app/'"
        :techUsed="repoFinder"
      />
      <OtherProject
        :githubLink="'https://github.com/Howakyl/sms-bot'"
        :title="'SMS Bot'"
...
<script>
import "~/assets/OtherProjects.css";
